...
namespace App\System\Doctrine\Uuid\Entity;
...
final readonly class EntityValueResolver implements ValueResolverInterface
{
    ...
    public function resolve(Request $request, ArgumentMetadata $argument): array
    {
        ...
        if (null === $object
            && (!$argument->isNullable() || $this->getIdentifier($request, $options, $argument->getName()) !== null)
        ) {
