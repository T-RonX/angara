const TIMING_LABELS = new Map([
    ...
    ['visibilityCollect', 'Visible wall collect'],
    ['visibilitySync', 'Visible wall sync'],
...
const COUNT_LABELS = new Map([
    ...
    ['visibilityUpdates', 'Visible wall updates'],
...
const VALUE_LABELS = new Map([
    ...
    ['wallCandidateColumns', 'Wall columns before view cull'],
