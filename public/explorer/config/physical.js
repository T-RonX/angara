...
export const physical = {
    ...
    planet: {
        ...
        companions: [
            ...
            // Test planet: sphere with 1 layer (extreme thin)
            {
                id: 'test-thin-sphere',
                name: 'Test Thin Sphere',
                cellTopology: 'hexsphere',
                hexFrequency: 16,
                maxDepth: 1,
                shape: {
                ...
                layerThicknessGrowth: 1.5,
                coreColor: 0xff6600,
                depthColors: [0xffcc00],
                gridColor: 0x0a0e16,
                background: 0x05070d,
                cellGap: 0.0,
                atmosphere: {
                    show: false,
                    showInResourceMode: false,
                    selectable: false,
                    thickness: 0.03,
                    sunIntensity: 1.0,
                    opacity: 1.0,
            ...
            // Test planet: noise with many layers (extreme thick)
            {
                id: 'test-thick-noise',
                name: 'Test Thick Noise',
                cellTopology: 'hexsphere',
                hexFrequency: 16,
                maxDepth: 8,
                shape: {
                ...
                layerThicknessGrowth: 1.5,
                coreColor: 0x660066,
                depthColors: [0x00ff00, 0x00cc00, 0x009900],
                gridColor: 0x0a0e16,
                background: 0x05070d,
                cellGap: 0.0,
                atmosphere: {
